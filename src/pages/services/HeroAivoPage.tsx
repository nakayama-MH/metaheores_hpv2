...
export const HeroAivoPage: React.FC = () => {
// ... (state and fetch)
  ...
  return (
    <main className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <ServiceIntroBanner 
        image="/assets/services/hero-aivo/hero-thumbnail.png"
        title="あなたの会社の情報をAIに正しく認識してもらい、おすすめしてもらうWeb制作サービス。"
        ...
        <div className="container mx-auto px-4 max-w-5xl text-center space-y-10">
          <div className="flex flex-col items-center">
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold leading-relaxed tracking-wider text-gray-900">
              検索の主役が「人」から「AI」へ変わる今、あなたのサイトは正しく読み<br className="hidden md:block" />
              取られていますか？
            </h2>
          ...
          <p className="text-sm md:text-base text-gray-600 leading-[2.2] font-medium max-w-3xl mx-auto text-justify md:text-center tracking-wide">
            ChatGPTやPerplexityなどのAI検索が普及する中、従来のSEO（検索エンジン最適化）だけでは不十分です。AIに正しく情報を渡す「LLMO（大規模言語モデル最適化）」の重要性を解説します。
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 max-w-5xl space-y-32">
        ...
        <section>
          ...
          <p className="mb-12 text-gray-600 leading-relaxed font-medium text-sm md:text-base tracking-wide">
            AI診断から、Web制作に関わる企画から運用までワンストップでご提供。ブランディングイメージを損なわず、一貫したブランド体験をお届けします。
          </p>
        ...
        <section>
          ...
          <p className="mb-12 text-gray-600 leading-relaxed font-medium text-sm md:text-base tracking-wide">
            AIに引用してもらいやすい情報を蓄積することで、広告費をかけずに、集客を増やします。
          </p>

          <div className="space-y-8">
            {[
              'AI検索エンジンでの引用率向上',
              'AI検索エンジン経由の流入・認知度を獲得',
              '正確な情報発信によるブランド価値の担保'
            ].map((item, idx) => (
